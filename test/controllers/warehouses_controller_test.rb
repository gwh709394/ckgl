...
class WarehousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post warehouses_url, params: { warehouse: { code: @warehouse.code, location: @warehouse.location, name: @warehouse.name, remark: @warehouse.remark } }
    end
  ...
  test "should update warehouse" do
    patch warehouse_url(@warehouse), params: { warehouse: { code: @warehouse.code, location: @warehouse.location, name: @warehouse.name, remark: @warehouse.remark } }
